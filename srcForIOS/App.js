    ...
    return ( 
      <Router>
        <Scene key="root" hideNavBar={true} hideTabBar={true} hideOnChildTabs={true} style={statusStyle}>
          ...
          <Scene key="demographics" component={Demographics} initial={demographicsInitial} />
